...
namespace DragonsBlood.Controllers.Resources
{
    ...
    public class DocumentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,DisplayText,Location")] Document document)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,DisplayText,Location")] Document document)
        {
            if (ModelState.IsValid)
            {
